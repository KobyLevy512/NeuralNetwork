...
namespace NeuralNetwork.Core
{
    ...
    { 
        ...
        //Layers
        public List<BigNL> HiddenLayers;
        ...
        private BigDN()
        {
            HiddenLayers = new List<BigNL>();
        }
        public BigDN(BigDN cpy, int newSeed = 0, double learningRate = 0)
        {
            ...
            {
                HiddenLayers.Add(new BigNL(cpy.HiddenLayers[i]));
            }
        ...
        public BigDN(int outputSize) : this(outputSize, 0) { }
        public BigDN(int outputSize, int seed) : this(outputSize, seed, Sigmoid, SigmoidDerivative) { }
        public BigDN(int outputsSize, int seed, Activation act, Activation der)
        {
            //Set the layers.
            HiddenLayers = new List<BigNL>();
        ...
        public static BigDN LoadFromFile(string filename)
        {
            BigDN ret = new BigDN();
            ...
            {
                ret.HiddenLayers.Add(BigNL.LoadFromFile(br));
            }
